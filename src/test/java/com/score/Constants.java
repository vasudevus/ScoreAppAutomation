...
import java.time.format.DateTimeFormatter;
    ...
    public final class Constants {
        ...
        public static final String TEST_RESOURCES_DIR = PROJECT_PATH + File.separator + "src\\test\\java\\resources";

        public static final String ANDROID_APK_PATH = TEST_RESOURCES_DIR + File.separator + "app" + File.separator + "theScore.apk";
        ...
        public static final String DEVICE_NAME = "Samsung SM-N986W";
        ...
        // "http://"+APPIUM_SERVER_HOST +":"+APPIUM_SERVER_PORT;
        //http://127.0.0.1:4723
        ...
        protected static final String EXTENT_REPORT_PATH = PROJECT_PATH + File.separator + "ExtentReports_Score\\";
